...
10. What are the advantages of using `curl` over the browser?
    Curl can be used when there is no website associated to a web server that you are trying to access. This use case is most often seen when working with through a container. In this case you can use curl to examine HTTP requests and responses. Also, tests of HTTP requests in curl can be conducted quickly through automation and the ability to make adjustments as you work.
...
33. Why would we never run `DELETE FROM <table-name>;` by itself?
    Without a SELECT statement, it would delete the entire table
---
